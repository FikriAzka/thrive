<!-- Individual Meeting Contents -->
<div id="meeting-{{ $meetingId }}"
    class="meeting-content {{ request('meeting_id') == $meetingId ? 'block' : 'hidden' }}">
    <div class="bg-white rounded-lg shadow-sm mb-6 p-6">
        <h1 class="text-xl font-semibold text-gray-800">Customer Satisfaction Score -
            {{ $meetingRatings->first()->meeting->nama_rapat }}</h1>

        @php
            // Similar calculations for individual meeting, but for $meetingRatings
            $satisfactionCounts = [
                'Very Dissatisfied' => 0,
                'Dissatisfied' => 0,
                'Neutral' => 0,
            ...
            foreach ($meetingRatings as $rating) {
            ...
            $totalRespondents = $meetingRatings->count();
            ...
            // Calculate percentages for this meeting
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
            ...
            <div class="flex gap-4 mt-4">
                ...
                @endforeach
                <div class="ml-auto">
                    <span class="font-semibold text-lg">Total Score:
                        {{ number_format($csatScore, 2) }}%</span>
                </div>
            </div>
        </div>
        ...
        <!-- Responses Table -->
        <div class="bg-white rounded-lg shadow-sm p-6" x-data="{ searchTerm: '' }">
            <div class="flex justify-between items-center mb-4">
                <div>
                    <h2 class="text-lg font-semibold text-gray-800">CSAT Responses -
                        {{ $meetingRatings->first()->meeting->nama_rapat }}</h2>
                    <p class="text-sm text-gray-500">
                        Showing {{ $meetingRatings->count() }} total responses
                        total responses
                    </p>
                </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($meetingRatings as $rating)
                            ...
                            <tr x-show="searchTerm === '' || 
                                ...
                                class="cursor-pointer hover:bg-gray-50 rating-row"
                            ...
                            <tr class="hidden details-row" data-rating-id="{{ $rating->id }}">
                                        ...
                                        <div class="bg-white rounded-lg shadow-sm p-4">
                                            ...
                                            <table class="w-full">
                                                <tbody class="divide-y divide-gray-100">
                                                    <tr>
                                                        <td class="py-2.5 text-sm text-gray-600 w-3/4">Berikan penilaian Anda secara keseluruhan terhadap Specialist yang membantu proses
                                                            onboarding.</td>
                                                        <td class="py-2.5">
                                                            <span
                                                    ...
                                                    <tr>
                                                        <td class="py-2.5 text-sm text-gray-600">Bagaimana kualitas
                                                            komunikasi tim kami?</td>
                                                        <td class="py-2.5">
                                                            <span
                                                    ...
                                                    <tr>
                                                        <td class="py-2.5 text-sm text-gray-600">Seberapa cepat respon
                                                            yang kami berikan?</td>
                                                        <td class="py-2.5">
                                                            <span
                                                    ...
                                                    <tr>
                                                        <td class="py-2.5 text-sm text-gray-600">Apakah solusi yang kami
                                                            berikan memuaskan?</td>
                                                        <td class="py-2.5">
                                                            <span
                                                    ...
                                                    <tr>
                                                        <td class="py-2.5 text-sm text-gray-600">Bagaimana pengalaman
                                                            Anda dengan tim support?</td>
                                                        <td class="py-2.5">
                                                            <span
                                                    ...
                                                    <tr>
                                                        <td class="py-2.5 text-sm text-gray-600">Seberapa jelas
                                                            informasi yang kami sampaikan?</td>
                                                        <td class="py-2.5">
                                                            <span
                                                    ...
                                                    <tr>
                                                        <td class="py-2.5 text-sm text-gray-600">Apakah timeline
                                                            pengerjaan sesuai ekspektasi?</td>
                                                        <td class="py-2.5">
                                                            <span
                                                    ...
                                                    <tr>
                                                        <td class="py-2.5 text-sm text-gray-600">Seberapa mungkin Anda
                                                            merekomendasikan kami?</td>
                                                        <td class="py-2.5">
                                                            <span
